...
namespace System
{
	internal static class ThrowHelper
	{
		...
		{
			throw new ArgumentOutOfRangeException(ThrowHelper.GetArgumentName(ExceptionArgument.index), Environment.GetResourceString(ThrowHelper.GetResourceName(ExceptionResource.ArgumentOutOfRange_Index)));
		}
		[SecuritySafeCritical]
