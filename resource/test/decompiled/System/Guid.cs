...
namespace System
{
	...
	public struct Guid : IFormattable, IComparable, IComparable<Guid>, IEquatable<Guid>
	{
		...
		private static bool TryParseGuid(string g, Guid.GuidStyles flags, ref Guid.GuidResult result)
		{
			...
			{
				if ((flags & Guid.GuidStyles.RequireDashes) != Guid.GuidStyles.None)
				{
					result.SetFailure(Guid.ParseFailureKind.Format, "Format_GuidUnrecognized");
					return false;
				}
			...
			{
				if ((flags & Guid.GuidStyles.RequireBraces) != Guid.GuidStyles.None)
				{
					result.SetFailure(Guid.ParseFailureKind.Format, "Format_GuidUnrecognized");
					return false;
				}
			...
			{
				if ((flags & Guid.GuidStyles.RequireParenthesis) != Guid.GuidStyles.None)
				{
					result.SetFailure(Guid.ParseFailureKind.Format, "Format_GuidUnrecognized");
					return false;
				}
		...
		{
			return Guid.StringToShort(str, &parsePos, requiredLength, flags, out result, ref parseResult);
		}
		[SecurityCritical]
		...
		{
			return Guid.StringToInt(str, &parsePos, requiredLength, flags, out result, ref parseResult);
		}
		[SecurityCritical]
		...
		{
			return Guid.StringToLong(str, &parsePos, flags, out result, ref parseResult);
		}
		[SecuritySafeCritical]
		...
		{
			a &= 15;
			return (char)((a > 9) ? ((char)(a - 10 + 97)) : ((char)(a + 48)));
		}
		...
		public string ToString(string format, IFormatProvider provider)
		{
			...
			if (flag2)
			{
				...
				array[offset++] = ',';
				array[offset++] = '{';
				offset = Guid.HexsToChars(array, offset, (int)this._d, (int)this._e, true);
				array[offset++] = ',';
				offset = Guid.HexsToChars(array, offset, (int)this._f, (int)this._g, true);
				array[offset++] = ',';
				offset = Guid.HexsToChars(array, offset, (int)this._h, (int)this._i, true);
				array[offset++] = ',';
				offset = Guid.HexsToChars(array, offset, (int)this._j, (int)this._k, true);
				array[offset++] = '}';
			}
			else
			{
