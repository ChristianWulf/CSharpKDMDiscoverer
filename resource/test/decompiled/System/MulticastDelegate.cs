	...
	public abstract class MulticastDelegate : Delegate
	{
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			else
			{
				...
				while (--num2 >= 0)
				{
					...
					if (method2 is RuntimeMethodInfo && !this.IsUnmanagedFunctionPtr() && (multicastDelegate.InvocationListLogicallyNull() || multicastDelegate._invocationCount.IsNull()))
					{
		...
		public sealed override bool Equals(object obj)
		{
			...
			else
			{
				...
				if ((multicastDelegate._invocationCount != (IntPtr)0 || !this.InvocationListLogicallyNull()) && multicastDelegate._invocationList is Delegate)
				{
		...
		public sealed override int GetHashCode()
		{
			if (this.IsUnmanagedFunctionPtr())
			{
				return ValueType.GetHashCodeOfPtr(this._methodPtr);
			}
			object[] array = this._invocationList as object[];
			if (array == null)
			{
